  ...
  if (generateButton && questionCountInput && questionsForm) {
    generateButton.addEventListener("click", function () {
      ...
      for (let i = 1; i <= questionCount; i++) {
        ...
        correctOptionInput.placeholder =
          "Enter the correct option (e.g., 1, 2, 3, or 4)";
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function updateBoxContainer(id) {
    ...
    const content = {
      ...
      <h2>Test Details</h2>
        <form id="testDetailsForm">
          <div class="form-group" style="margin-bottom: 1rem;">
            ...
            <input type="text" id="testID" name="testID" class="form-control" placeholder="Enter test ID" required style="width: 314px; padding: 0.5rem;">
          </div>
          <div>
      ...
      <form id="studentDetailsForm">
          <div class="form-group" style="margin-bottom: 1rem;">
            ...
            <input type="text" id="studentID" name="studentID" class="form-control" placeholder="Enter student ID" required style="width: 314px; padding: 0.5rem;">
          </div>
          <div>
    ...
    if (id === "profile") {
      ...
      fetch("get_test_counts.php")
        ...
        .then((data) => {
          document.querySelector("#createdTests").innerText =
            data.total_test || "0";
          document.querySelector("#publishedTests").innerText =
            data.publish_test || "0";
        })
  ...
  function displayTestDetails(data) {
    let output =
      '<table style="width:100%;text-align: center;"><thead><tr><th>Date</th><th>Student ID</th><th>Student Name</th><th>Total Marks</th><th>Obtained Marks</th><th>Percentage</th><th>Status</th><th>Activity</th></tr></thead>';
  ...
  function downloadCSV(data) {
    let csvContent =
      "Date,Student ID,Student Name,Total Marks,Obtained Marks,Percentage,Status,Activity\n";
  ...
  function displayStudentDetails(data) {
    let output =
      '<table style="width:100%;text-align: center;"><thead><tr><th>Test Date</th><th>Student ID</th><th>Student Name</th><th>Test ID</th><th>Test Name</th><th>Subject</th><th>Total Question</th><th>Total Marks</th><th>Obtained Marks</th><th>Percentage</th><th>Status</th><th>Activity</th></tr></thead>';
